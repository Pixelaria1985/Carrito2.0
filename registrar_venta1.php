        ...
        try {
            ...
            foreach ($_SESSION['carrito_venta'] as $item) {
                ...
                $stmt = $conexion->prepare("
                    INSERT INTO ventas (producto_id, cantidad, fecha_venta, metodo_pago)
                    VALUES (?, ?, NOW(), ?)
                ");
...
<div class="container mt-4">
    ...
    <form method="POST" class="form-inline mb-3">
        ...
        <select name="producto_id" class="form-control mr-2" required>
            <?php
            $productos = $conexion->query("SELECT * FROM productos WHERE stock > 0")->fetchAll(PDO::FETCH_ASSOC);
        ...
        <input type="number" name="cantidad" class="form-control mr-2" min="1" required>
